...
<body>
    ...
    <div id="main">
        ...
        <button class=" dropdown-toggle btn btn-light m-3" type="button" data-bs-toggle="offcanvas" data-bs-target="#subcategory" aria-controls="subcategory">Sous Catégories</button>
        ...
        <div class="card-group p-3">
            ...
            <div class="card">
                ...
                <img src="./assets/chaussure1.webp" class="card-img-top h-300px img-cover" alt="...">
                <div class="card-body">
